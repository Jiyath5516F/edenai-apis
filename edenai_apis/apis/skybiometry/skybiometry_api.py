...
from edenai_apis.features.image.face_detection.face_detection_dataclass import FaceAccessories, FaceBoundingBox, FaceEmotions, FaceFacialHair, FaceFeatures, FaceLandmarks
